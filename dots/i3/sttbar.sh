...
outside_temp(){                                                                                                                                           
  ...
  echo -n "\"background\":\"$bg\","                                                                                                                       
  echo -n "\"color\":\"#1f1e1c\","                                                                                                                        
  echo -n "\"full_text\":\" $(curl wttr.in/thua-thien?format=3 | cut -c13-) \","                                                                          
  common                                                                                                                                                  
  echo -n "},"                                                                                                                                            
 }      
memory() {
  ...
  echo -n "\"full_text\":\" ◮ $(~/.config/i3/memory.py)% \","
...
core0(){
  ...
  echo -n ",{"
  echo -n "\"name\":\"core0\","
  echo -n "\"full_text\":\" ${cau} $(.config/i3/temp.py) \","
  echo -n "\"background\":\"$bg\","
  echo -n "\"color\":\"#1f1e1c\","
  common
  echo -n "},"
...
core1(){
  ...
  echo -n ",{"
  echo -n "\"name\":\"core0\","
  echo -n "\"full_text\":\" ${cau} $(.config/i3/temp1.py) \","
  echo -n "\"background\":\"$bg\","
  echo -n "\"color\":\"#1f1e1c\","
  common
  echo -n "},"
